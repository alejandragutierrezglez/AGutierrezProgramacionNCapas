using ConsoleApp1.OperacionesReference;
using System;
...
namespace PL
{
    public class Program
    {
        ...
        {
            OperacionesClient client = new OperacionesClient();
            int a = 10, b = 5;
            int resultadoSuma = client.SumarNumeros(a, b);
            Console.WriteLine("El resultado de la suma es: "+resultadoSuma);
            int resultadoResta = client.RestarNumeros(a, b);
            Console.WriteLine("El resultado de la resta es: "+resultadoResta);
            int resultadoMultiplicacion = client.MultiplicarNumeros(a, b);
            Console.WriteLine("El resultado de la multiplicacion es: "+resultadoMultiplicacion);
            int resultadoDivision=client.DividirNumeros(a, b);
